...
public class coin_score_animation_level1 : MonoBehaviour {
	...
	void Start () {
		...
		this.unitLength = transform.localScale.x;
	}
...
//			transform.localScale = new Vector3 (transform.localScale.x / 100, transform.localScale.y / 100, transform.localScale.z / 100);
		...
		if (shrinking == false && gotPoint == true && scoreAppeared == false && this.increaseHeight < 3 * this.unitLength) {
